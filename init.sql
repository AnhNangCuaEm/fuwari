...
(
    ...
    'Cherry Cake',
    '甘酸っぱいチェリーのケーキ。',
    'Sweet and sour cherry cake.',
    '["小麦粉", "砂糖", "バター", "卵", "チェリー", "生クリーム", "ベーキングパウダー", "バニラエッセンス"]'::jsonb,
    '["Flour", "Sugar", "Butter", "Eggs", "Cherries", "Heavy Cream", "Baking Powder", "Vanilla Extract"]'::jsonb,
    '["小麦", "卵", "乳", "果物"]'::jsonb,
    '["Wheat", "Eggs", "Dairy", "Fruits"]'::jsonb,
    'cakes',
    500,
    22,
    '/2dimage/cherrycake.png',
    '/3dmodels/cherrycake/scene.gltf'
),
(
    11,
    'チョコレートベリーケーキ',
    ...
    'ふわふわのチョコレートベリーケーキ。',
    'Fluffy chocolate berry cake.',
    '["小麦粉", "砂糖", "バター", "卵", "牛乳", "ベーキングパウダー", "塩", "バニラエッセンス", "チョコレート", "ベリー"]'::jsonb,
    '["Flour", "Sugar", "Butter", "Eggs", "Milk", "Baking Powder", "Salt", "Vanilla Extract", "Chocolate", "Berries"]'::jsonb,
    '["小麦", "卵", "乳", "果物"]'::jsonb,
    '["Wheat", "Eggs", "Dairy", "Fruits"]'::jsonb,
    'original',
    600,
    10,
    '/2dimage/chocoberry.png',
    '/3dmodels/chocoberry/scene.gltf'
),
(
    12,
    'フルーツケーキ',
    ...
    'フルーツたっぷりのケーキ。',
    'Fruit-filled cake.',
    '["小麦粉", "砂糖", "バター", "卵", "牛乳", "ベーキングパウダー", "塩", "バニラエッセンス", "フルーツミックス"]'::jsonb,
    '["Flour", "Sugar", "Butter", "Eggs", "Milk", "Baking Powder", "Salt", "Vanilla Extract", "Mixed Fruits"]'::jsonb,
    '["小麦", "卵", "乳", "果物"]'::jsonb,
    '["Wheat", "Eggs", "Dairy", "Fruits"]'::jsonb,
    'original',
    750,
    5,
    '/2dimage/fruitcake.png',
    '/3dmodels/fruitcake/scene.gltf'
),
(
    13,
    'ハニーケーキ',
    ...
    'ふわふわのハニーケーキ。',
    'Fluffy honey cake.',
    '["小麦粉", "砂糖", "バター", "卵", "牛乳", "ベーキングパウダー", "塩", "バニラエッセンス", "はちみつ"]'::jsonb,
    '["Flour", "Sugar", "Butter", "Eggs", "Milk", "Baking Powder", "Salt", "Vanilla Extract", "Honey"]'::jsonb,
    '["小麦", "卵", "乳", "蜂蜜"]'::jsonb,
    '["Wheat", "Eggs", "Dairy", "Honey"]'::jsonb,
    'cakes',
    350,
    15,
    '/2dimage/honeycake.png',
    '/3dmodels/honeycake/scene.gltf'
),
(
    14,
    'プチブルーケーキ',
    ...
    400,
    16,
    '/2dimage/petitblue.png',
    '/3dmodels/petitblue/scene.gltf'
),
(
    15,
    'ロールケーキ',
