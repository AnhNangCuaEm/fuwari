  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 pt-32 pb-16 flex-1">
        ...
        {/* News Letter */}
        <section className="mt-20">
          <div className="bg-[#fdf2f0] rounded-3xl p-8 md:p-16 text-center relative overflow-hidden">
            <div className="absolute -top-10 -left-10 size-40 bg-black/10 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-10 -right-10 size-40 bg-black/10 rounded-full blur-3xl"></div>
            <div className="relative z-10 max-w-xl mx-auto flex flex-col gap-6">
              <Image src="/icons/mail.svg" alt="Mail Icon" width={40} height={40} className='self-center'/>
              <h2 className="text-2xl font-serif font-bold text-gray-900">{t('home.news.title')}</h2>
              <p>{t('home.news.description')}</p>
              <form className="flex flex-col sm:flex-row gap-3 mt-4" onSubmit={handleSubmit}>
                <input 
                  name='email'
                  className="flex-1 py-2 px-4 rounded-full border border-gray-200 focus:border-cosmos-300 focus:ring-1 focus:ring-cosmos-300 outline-none bg-white text-gray-900 placeholder:text-gray-400" 
                ...
                />
                <button 
                  className="px-8 py-2 rounded-full bg-gray-700 text-white font-bold hover:bg-gray-900 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed" 
                  type="submit"
              ...
              <p className="text-xs mt-2">{t('home.news.promise')}</p>
            </div>
          </div>
        </section>
      </div>
